  ...
  const faqs = [
    {
      ...
      answer:
        "Browse our vendor listings, select your preferred vendor, and click 'Book Now'. You can also add services to your cart and checkout together.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, you can cancel or modify bookings up to 48 hours before the event date. Cancellation charges may apply as per vendor policies.",
    },
    {
      question: "How do I become a vendor?",
      answer:
        "Click on 'Become a Vendor' in the navigation menu, fill out the application form, and our team will review your submission within 2-3 business days.",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Have questions about our services? Need help planning your event? We're here to help you every step of the
            way.
          </p>
        </div>
