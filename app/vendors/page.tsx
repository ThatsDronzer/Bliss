      ...
      <footer className="bg-gray-900 text-white py-12 mt-auto">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4 text-pink-400">Blissmet</h3>
              <p className="text-gray-300">
                India's premier event planning platform connecting you with the best vendors for all occasions.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/vendors" className="text-gray-300 hover:text-pink-400 transition-colors">
                    Explore Vendors
                  </Link>
                </li>
                <li>
                  <Link href="/home-service" className="text-gray-300 hover:text-pink-400 transition-colors">
                    Home Services
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/vendors?category=Venue" className="text-gray-300 hover:text-pink-400 transition-colors">
                    Venues
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <address className="not-italic text-gray-300">
                <p>Email: info@blissmet.in</p>
                <p>Phone: +91 98765 43210</p>
              </address>
            </div>
          </div>
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>© 2024 Blissmet. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
