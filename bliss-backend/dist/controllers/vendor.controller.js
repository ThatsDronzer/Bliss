 ...
 */
export const getVendorByClerkId = async (req, res, next) => {
    try {
        const { id } = req.params;
        if (!id) {
 ...
 */
export const updateVendorByClerkId = async (req, res, next) => {
    try {
        const { id } = req.params;
        if (!id) {
            throw new AppError('Vendor ID is required', 400);
 ...
 */
export const getVendorServicesForExplore = async (req, res, next) => {
    try {
 ...
 */
export const getVendorVerification = async (req, res, next) => {
    try {
 ...
 */
export const submitVendorVerification = async (req, res, next) => {
    try {
